                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="text-center mx-auto" style="max-width: 700px;">
                                ...
                                <p class="mb-4">We're always here to assist you! Whether you have questions about our products, need support, or want to explore partnership opportunities, feel free to get in touch with us.</p>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="h-100 rounded">
                                <iframe class="rounded w-100" 
                                style="height: 400px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15549.81912699637!2d80.21967235!3d13.0066856!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5267709aa40a7d%3A0xca348695fc512750!2sGuindy%2C%20Chennai%2C%20Tamil%20Nadu!5e0!3m2!1sen!2sin!4v1709638642322!5m2!1sen!2sin" 
                        ...
                        <div class="col-lg-7">
                            <form action="" class="">
                                ...
                                <button class="w-100 btn form-control border-secondary py-3 bg-white text-primary" id="contactSubmit" type="submit">Submit</button>
                            </form>
                        </div>
                        <div class="col-lg-5">
                            <div class="d-flex p-4 rounded mb-4 bg-white">
                                ...
                                <div>
                                    <h4>Address</h4>
                                    <p class="mb-2">123 Street Guindy,Chennai</p>
                                </div>
                            </div>
                            <div class="d-flex p-4 rounded mb-4 bg-white">
                                ...
                                <div>
                                    <h4>Mail Us</h4>
                                    <p class="mb-2">BioPowerHarvest@gmail.com</p>
                                </div>
                            </div>
