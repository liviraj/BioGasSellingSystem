            ...
            <div class="container py-5">
                <div class="p-5 bg-light rounded">
                    <div class="row g-4">
                        ...
                        <select class="w-100 form-control border-0 py-3 mb-4" aria-label="Default select example" name="gasType" id="gasType">
  							<option selected>Choose Cylinder type.....</option>
  							<option value="Domestic Gas">Domestic Gas</option>
  							<option value="Commercial Gas">Commercial Gas</option>
						</select>
                        </div>
                        <div class="col-lg-6">
                            <select class="w-100 form-control border-0 py-3 mb-4" aria-label="Default select example" name="serviceProvider" id="serviceProvider">
  							 	<option selected>Choose distributer.....</option>
  								<option value="BioPower Harvest">BioPower Harvest</option>
							</select>
                             <input type="text" class="w-100 form-control border-0 py-3 mb-4" placeholder="Contact No" id="contactNo" name="contactNo">
                        </div>
                        </div>
                         <div class="row">
                        <div class="col-lg-6">
                             <input type="text" class="w-100 form-control border-0 py-3 mb-4" placeholder="Address1 Ex. Plot No" id="address1" name="address1">
							<input type="text" class="w-100 form-control border-0 py-3 mb-4" placeholder="Enter Your City" id="city" name="city">                             
                        </div>
                        <div class="col-lg-6">
                             <input type="text" class="w-100 form-control border-0 py-3 mb-4" placeholder="Address2 Ex. Street/Floor Name" id="address2" name="address2">
                             <input type="text" class="w-100 form-control border-0 py-3 mb-4" placeholder="Enter Your Pincode" id="pincode" name="pincode">
                        </div>
                        </div>
                        <div class="col-lg-12">
                        	<button class="w-100 btn form-control border-secondary py-3 bg-white text-primary" id="contactSubmit" type="submit" name="submit" value="Book Now">Book Now</button>
                        </div>
                        </form>
                    </div>
                </div>
